...
To support this evaluation, we introduce the **Human-Preference FashionIQ (HP-FashionIQ)** dataset, built from the validation set of the [FashionIQ dataset](https://drive.google.com/drive/folders/17WgyAkiTb21y8BdTNJptyfEm4wjk4FPx?usp=drive_link), with human annotations from 61 participants. FashionIQ was selected for its detailed attribute supervision and alignment with real-world e-commerce search behaviors.

For more information, see **Section 4** and **Appendix C** of our paper.

## Preparation

1. Download and set up the [FashionIQ dataset](https://drive.google.com/drive/folders/17WgyAkiTb21y8BdTNJptyfEm4wjk4FPx?usp=drive_link).
